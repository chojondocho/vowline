...
Remove only marked Vowline instruction blocks. The current activation body is maintained in `guidance/VOWLINE_ACTIVATION.md`, but removal should key only on the markers:
